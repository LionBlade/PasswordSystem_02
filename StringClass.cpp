...
//
// Purpose: This file specifies what each function from the StringClass class is supposed
//          to do.
//////////////////////////////////////////////////////////////////////////////////////////////
...
void StringClass::SubstringFunction(void) {
  ...
  for (int i = 0; i < str.size(); i++) {
    ...
    // If there's an upper case alphabet at the beginning of the string, then don't create the substrings.
      ...
      // Display the output.
      cout << "\nThe first alphabet is an upper case alphabet.\n";
      cout << "No substrings were made.\n";
      cout << "String:" << str << '\n';
      cout << "String Length:" << str.size() << '\n';
      break;
    }
    // If there are no upper case alphabets within the string, then don't create the substrings.
      ...
      // Display the output.
      cout << "\nThere's no upper case alphabet.\n";
      cout << "No substrings were made.\n";
      cout << "String:" << str << '\n';
      cout << "string Length:" << str.size() << '\n';
    }
